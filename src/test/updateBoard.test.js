...
it('Should return an array composed of player symbols in different positions', () => {
  document.body.innerHTML = ` <div class="cells" data-datasymbol="A" id="c0">X</div> <div class="cells" data-datasymbol="" id="c1"></div> <div class="cells" data-datasymbol="" id="c2"></div> 
